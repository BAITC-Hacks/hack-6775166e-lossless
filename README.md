...
Это работает без API-ключа: текст помечен как разбор по рассчитанным фактам. Для живого AI-ответа задайте ключ и модель по инструкции ниже и перезапустите сервер. Ключ не нужен для вычисления Score и не должен попадать в Git или браузерную форму.
