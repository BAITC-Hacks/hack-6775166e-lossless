...
**Симулятор городских решений:** распределите бюджет **100** между пятью мерами для пяти условных районов Астаны и посмотрите, как изменится качество жизни по формуле задачи. Можно сравнить свой план с лучшей заменой одного решения и оптимумом модели, а затем спросить AI-советника о компромиссах.
...
3. Нажмите **«Улучшить одно распоряжение»**, затем **«Сравнить с оптимумом»**. Оба варианта предлагаются для сравнения; применить их можно только своим решением.
...
- Укажите район для районной меры; для городской выберите **«Весь город»**. Карточку можно перетащить на схему или выбрать цель кнопкой **«Направить меру»** — этот способ работает и с клавиатуры.
- Нажмите **«Подписать распоряжения»**. Отчёт покажет Score, изменения районов, диаграммы, синергии и объяснение. На схеме переключайте **«Было» / «Стало»**.
...
- **Реализация:** Python, HTML, CSS, JavaScript и Canvas написаны для этой задачи. До старта в репозитории были инфраструктурные скрипты и рабочие инструкции; состав описан в [плане команды](docs/parallel-agents.md).
